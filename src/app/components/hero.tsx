        ...
        <div className="bg-white bg-opacity-90 p-6 rounded-3xl shadow-md border border-slate-300 text-center w-full laptop:w-3/5 max-w-4xl">
          <BoxReveal>
            <p className="text-lg mobile:text-xl laptop:text-2xl text-black leading-relaxed">
              I am a Junior Software Engineer proficient in <span className="text-yellow-500 font-extrabold">JavaScript</span> / <span className="text-blue-500 font-extrabold">TypeScript</span>. I enjoy working with frameworks like <span className="text-gray-800 font-extrabold">NextJs</span> and <span className="text-blue-600 font-extrabold">React.js</span>, and have experience with various JavaScript libraries. I also work with <span className="text-green-900 font-extrabold">Python</span>, with extensive projects in both JavaScript/TypeScript and Python.
            </p>
          </BoxReveal>
        </div>
